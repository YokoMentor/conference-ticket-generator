...
function CongratsPage(){
    return (
        <div className='flex flex-col justify-center items-center text-center w-[344px] md:w-[786px] mb-9 md:mb-12'>
            ...
            <div className='bg-ticket-mobile md:bg-ticket-desktop bg-no-repeat w-[346px] h-[164px] md:w-[600px] md:h-[280px] flex justify-between mx-4'>
                <div className='mt-3 md:mt-4'>
                    ...
                    <div className='flex text-left ml-4 md:ml-6'>
                        ...
                        <div>
                            <h2 className='text-heading text-[18px] md:text-[28px] mt-2'>Jonatan Kristof</h2>
                            <div className='flex items-center'>
                                <img src={iconGitHub} alt="icon GitHub" className='w-[16px] h-[16px] md:w-[22px] md:h-[22px] mr-1'/>
                                <p className='text-paragraph text-[14px] md:text-[18px]'>@jonatankristof0101</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='-rotate-90 w-[22px] h-[64px] md:w-[24px] md:h-[88px] text-paragraph text-[20px] md:text-[28px] mt-16 md:mt-[138px]'>60910#</div>
            </div>
        </div>
    )
}
